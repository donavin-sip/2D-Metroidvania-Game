...
public class Weapon : MonoBehaviour
{
    ...
    Vector3 angles = new Vector3(90.0f, 90.0f, 0.0f);      // sets the angle of the weapon from 0, 0, 0 degrees
    Quaternion rotation;
    ...
    void Fire()     // weapon fire logic
    {
        ...
        instFireRB.AddForce(Vector3.right * speed);                                                   // Propels object forward from firePoint
